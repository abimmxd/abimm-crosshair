var CrosshairUrl = "https://media.discordapp.net/attachments/1060486916757270580/1070117826515443772/NS_White_size.png"
var Checked = false
var Dimension = 0.4
...
function UpdateCrosshair() {
    if (value_user) {
        ...
        if (dimension_value.value != "") {
            ...
            crosshair.src = "https://media.discordapp.net/attachments/1060486916757270580/1070117826515443772/NS_White_size.png"
            CrosshairUrl = "https://media.discordapp.net/attachments/1060486916757270580/1070117826515443772/NS_White_size.png"
            $.post('http://crosshair_built_in/save_data', JSON.stringify({
                crosshair: CrosshairUrl,
                checked: Checked,
                dimension: Dimension
